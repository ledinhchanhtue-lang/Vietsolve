        ...
        <section className="py-20 lg:py-32 bg-gradient-to-br from-gray-50 to-red-50/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              className="text-center mb-16"
            >
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">Cơ cấu phòng ban</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">Đội ngũ chuyên nghiệp, tận tâm và sáng tạo</p>
            </motion.div>
            ...
            >
              <div className="text-center">
                <Users className="w-20 h-20 text-red-600 mx-auto mb-6" />
                <h3 className="text-3xl font-bold text-gray-900 mb-4">Ban quản lý</h3>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
                  Đội ngũ lãnh đạo giàu kinh nghiệm, dẫn dắt VietSolve phát triển và đồng hành cùng khách hàng
                </p>
                <Link href="/contact">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
