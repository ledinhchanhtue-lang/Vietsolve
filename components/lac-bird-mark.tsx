 ...
 *
 * The strokes draw themselves in when the section scrolls into view: every
 * path carries pathLength="1" plus .vs-draw (a one-shot dashoffset animation),
 * and because everything sits inside a TechLayer, the animation is paused
 * until the layer reports itself visible. Reduced-motion shows the finished
 * drawing immediately.
 *
      ...
      <div className="relative aspect-square overflow-hidden rounded-2xl border border-white/15 bg-white/5">
        <TechLayer>
          ...
          <svg viewBox="0 0 240 240" className="absolute inset-0 h-full w-full" aria-hidden="true">
            ...
            {/* Body and swept wing — LED-draws on first view */}
            <g
              stroke="#fff"
              strokeWidth="2.25"
              fill="none"
            ...
            >
              <path d="M62 152 C 84 118, 122 96, 168 92" pathLength={1} className="vs-draw vs-anim" />
              <path
                d="M168 92 C 152 108, 132 120, 108 128"
                pathLength={1}
                className="vs-draw vs-anim"
                style={{ animationDelay: "0.35s" }}
              />
              <path
                d="M62 152 C 78 150, 96 144, 108 128"
                pathLength={1}
                className="vs-draw vs-anim"
              ...
              {/* Tail feathers */}
              <path
                d="M62 152 C 48 160, 36 172, 28 188"
                pathLength={1}
                className="vs-draw vs-anim"
                style={{ animationDelay: "0.75s" }}
              />
              <path
                d="M70 158 C 58 170, 50 182, 46 196"
                pathLength={1}
                className="vs-draw vs-anim"
                style={{ animationDelay: "0.9s" }}
              />
              <path
                d="M80 162 C 72 176, 68 188, 66 202"
                pathLength={1}
                className="vs-draw vs-anim"
            ...
            {/* Head and beak — the one red element, drawn last */}
            <g stroke="#f87171" strokeWidth="2.25" fill="none" strokeLinecap="round">
              <path
                d="M168 92 C 180 86, 192 82, 206 82"
                pathLength={1}
                className="vs-draw vs-anim"
