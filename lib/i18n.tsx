...
export const translations = {
  vi: {
    ...
    hero: {
      badge: "Agency Sáng tạo & Công nghệ",
    ...
    roi: {
      ...
      perMonth: "/tháng",
      disclaimerTitle: "Đây là ước tính tham khảo",
      disclaimerBody:
        "Công cụ này minh họa cách ngân sách và tỷ lệ chuyển đổi ảnh hưởng đến kết quả. Con số hiển thị là ước tính mang tính tham khảo, không phải cam kết và không dựa trên số liệu của một khách hàng cụ thể. Kết quả thực tế phụ thuộc vào ngành, sản phẩm và thị trường.",
  ...
  en: {
    ...
    hero: {
      badge: "Creative & Technology Agency",
      title1: "CREATIVE AND TECH",
      title2: "SOLUTIONS FOR",
    ...
    roi: {
      ...
      perMonth: "/month",
      disclaimerTitle: "This is an illustrative estimate",
      disclaimerBody:
        "This tool illustrates how budget and conversion rate affect outcomes. The figures shown are indicative estimates, not commitments, and are not drawn from any specific client's results. Actual outcomes depend on your industry, product and market.",
